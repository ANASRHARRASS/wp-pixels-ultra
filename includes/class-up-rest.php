...
class UP_REST {
	...
	public static function deadletter_items( WP_REST_Request $request ) {
		...
		if ( ! method_exists( 'UP_CAPI', 'list_deadletter' ) ) {
			return new WP_REST_Response( array( 'error' => 'no_deadletter' ), 500 );
		}
	...
	public static function deadletter_retry( WP_REST_Request $request ) {
		...
		if ( ! $id ) {
			return new WP_REST_Response( array( 'error' => 'id required' ), 400 );
		}
		if ( ! class_exists( 'UP_CAPI' ) ) {
			return new WP_REST_Response( array( 'error' => 'no_capi' ), 500 );
		}
		if ( ! method_exists( 'UP_CAPI', 'retry_deadletter' ) ) {
			return new WP_REST_Response( array( 'error' => 'no_deadletter' ), 500 );
		}
	...
	public static function deadletter_delete( WP_REST_Request $request ) {
		...
		if ( ! method_exists( 'UP_CAPI', 'delete_deadletter' ) ) {
			return new WP_REST_Response( array( 'error' => 'no_deadletter' ), 500 );
		}
	...
	public static function logs( WP_REST_Request $request ) {
		...
		if ( ! method_exists( 'UP_CAPI', 'get_logs' ) ) {
			return new WP_REST_Response( array( 'error' => 'no_logs' ), 500 );
		}
