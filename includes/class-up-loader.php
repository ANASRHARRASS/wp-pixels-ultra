    ...
    public static function init() {
        ...
        class UP_Loader {
            public static function init() {
                ...
                // include if present (union of core includes from branches)
                foreach ( array(
                    ...
                    // additional helper files introduced on release branch
                    'settings.php',
                    'api-providers.php',
                    'ingest-handler.php',
                ) as $f ) {
                ...
                add_action( 'wp_enqueue_scripts', function() {
                    if ( defined( 'UP_PLUGIN_URL' ) ) {
                        ...
                        // Enqueue GTM forwarder script for client-side GTM integration (if present)
                        if ( file_exists( UP_PLUGIN_DIR . 'assets/up-gtm-forwarder.js' ) ) {
                            wp_enqueue_script( 'up-gtm-forwarder', UP_PLUGIN_URL . 'assets/up-gtm-forwarder.js', array(), defined( 'UP_VERSION' ) ? UP_VERSION : false, true );
                        }
